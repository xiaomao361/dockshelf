...
用户确认本轮方向，并授权收口、签名和 GitHub Release。源码版本固定为 0.1.4（2026091504），发布说明见 `docs/RELEASE_NOTES_v0.1.4.md`，签名与分发证据见 `docs/RELEASE_v0.1.4.md`。此前 0.1.1–0.1.4 候选回执是历史记录；正式分发包位于 `.build/releases/v0.1.4/`。
